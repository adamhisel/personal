...
public class JoinTeamActivity extends AppCompatActivity implements PasswordInputDialogFragment.PasswordInputListener {
    ...
    private void joinTeamPlayer(){
        ...
        String url = "";
        if(isPrivate == true) {
            url = "http://coms-309-018.class.las.iastate.edu:8080/teams/" + teamId + "/players/" + playerId + "/" + teamPassword;
        }
        else{
            url = "http://coms-309-018.class.las.iastate.edu:8080/teams/" + teamId + "/players/" + playerId + "/dummy";
        }
    ...
    private void joinTeamFan(){
        ...
        String url = "http://coms-309-018.class.las.iastate.edu:8080/teams/" + teamId + "/fans/" + fanId;
